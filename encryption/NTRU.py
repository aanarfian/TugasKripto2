import sys
from .NTRUutils.NTRUencrypt import NTRUencrypt
from .NTRUutils.NTRUdecrypt import NTRUdecrypt
from .NTRUutils.NTRUutil import *
...
def genkey():
    ...
    pub,priv = N1.genPubPriv()
    return(pub,priv)

def encryptntru(msg,pub):
    N2 = NTRUencrypt()
    N2.readPub(pub)
...
def decryptntru(chipher, priv):
    N1 = NTRUdecrypt()
    N1.readPriv(priv)
    N1.decryptString(chipher)
    return(N1.M)
...
if __name__ == "__main__":
    ...
    MSG = """
        ...
        """
    chipher = encryptntru(MSG,pub)
    decrypt = decryptntru(chipher, priv)
    print('\nchipher', chipher)
